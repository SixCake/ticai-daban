# -*- coding: utf-8 -*-
"""高位龙头断板 + 二波状态机（精简5态）— 唯一出处（研究29验证产物）

定位（方案 龙头断板二波追踪层 Phase 2）: 现有天梯/角色是"当日涨停快照",
前几日龙头今日未涨停即被完全丢弃。本模块提供一个 additive 的"龙头断板"
持久层口径: 近N日题材龙头∪市场高板即使今日未涨停也保留追踪, 用5态刻画
其高位状态。**仅作展示/风险标注, 不含任何买入语义**(研究29证伪: 整个高位
龙头断板cohort前向收益为负, 高位均值回归主导, 不能作打板买入信号)。
...
def build_cohort(recent_leaders, recent_highboards, exclude,
    ...
    """龙头断板cohort(唯一出处): 近N日题材龙头∪市场高板 - 今日涨停池, 过高位守卫。
